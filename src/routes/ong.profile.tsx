...
function OngProfile() {
  return (
    <AppShell role="ong">
      <div className="bg-gradient-to-br from-success to-primary p-6 text-white shadow-elegant">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm opacity-90 flex items-center gap-1"><MapPin className="h-3.5 w-3.5" /> Blumenau, SC · Verificada <BadgeCheck className="h-3.5 w-3.5" /></p>
          </div>
        </div>
      ...
      <div className="mt-4 rounded-2xl border border-border/60 bg-card p-5 shadow-soft">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {["Alimentos", "Saúde", "Abrigo", "Logística", "Doações"].map((t) => (
